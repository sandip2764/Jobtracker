...
import { FaDownload , FaBriefcase, FaCheck, FaClock, FaEnvelope, FaIndianRupeeSign, FaCalendar } from "react-icons/fa6";
import CardNav from '@/Components/CardNav';
import GradientText from '@/Components/GradientText';
import Dropdown from '@/Components/DropdownDays';
            ...
            <main className="mt-20">
                ...
                <header className="p-6 sm:p-8 ">
                    <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-4">
                        ...
                        <div className="flex items-center space-x-2 flex-shrink-0">
                            ...
                            <div>
                                <RainbowButton className="mt-4 max-sm:text-xs max-sm:p-2" variant=""><FaDownload className="text-gray-200"/>Export</RainbowButton>
                            </div>
                ...
                <div className="bg-[#060010] border border-[#392e4e] rounded-lg p-4 relative mx-4">
                    <div className="grid grid-cols-6 grid-rows-2 gap-4 mb-4">
                        <div className="col-span-2 bg-[#0D0716] border border-[#392e4e] rounded-xl py-2 px-2 grid place-items-center">
                            <div className="flex justify-around items-center gap-4 w-full">
                                ...
                                <div>
                                    <SparkLine data={[200, 24, 220, 260, 240, 380, 100, 240, 280, 240]} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-span-2 col-start-3 bg-[#0D0716] border border-[#392e4e] p-2 rounded-xl grid place-items-center">
                            <div className='flex justify-around items-center gap-4'>
                                <div>
                                    <h3 className='text-gray-200 font-medium text-lg mb-4'>Average Response Time</h3>
                                    <GradientText
                                        colors={["#8660fa", "#a855f7", "#8400ff", "#a855f7", "#8660fa"]}
                                        animationSpeed={10}
                                        showBorder={false}
                                        className="custom-class"
                                    >
                                        <p className="text-5xl font-extrabold mb-2">5 days</p>
                                    </GradientText>
                                </div>
                                <div>
                                    <SparkLine data={[220, 140, 280, 330, 260, 370, 190, 230, 350, 300]}/>
                                </div>
                            </div>
                        </div>
                        <div className="col-span-2 col-start-1 row-start-2 bg-[#0D0716] border border-[#392e4e] p-2 rounded-xl grid place-items-center " >
                            <div className='flex justify-around items-center gap-4 w-full'>
                                <div>
                                    <h3 className='text-gray-300 font-medium text-lg mb-4'>Interview Conversion</h3>
                                    <GradientText
                                        colors={["#8660fa", "#a855f7", "#8400ff", "#a855f7", "#8660fa"]}
                                        animationSpeed={10}
                                        showBorder={false}
                                        className="custom-class"
                                    >
                                        <p className="text-5xl font-extrabold mb-1">37.5%</p>
                                    </GradientText>
                                </div>
                                <div>
                                    <SparkLine data={[160, 200, 250, 300, 280, 360, 240, 320, 210, 290]}/>
                                </div>
                            </div>
                        </div>
                        <div className="col-span-2 col-start-3 row-start-2 bg-[#0D0716] border border-[#392e4e] p-2 rounded-xl grid place-items-center">
                            <div className='flex justify-around items-center gap-4'>
                                <div>
                                    <h3 className='text-gray-300 font-medium text-xl mb-4'>Active Applications</h3>
                                    <GradientText
                                        colors={["#8660fa", "#a855f7", "#8400ff", "#a855f7", "#8660fa"]}
                                        animationSpeed={10}
                                        showBorder={false}
                                        className="custom-class"
                                    >
                                        <p className="text-5xl font-extrabold mb-1">100</p>
                                    </GradientText>
                                </div>
                                <div>
                                    <SparkLine data={[130, 260, 230, 310, 200, 340, 260, 380, 240, 300]}/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='w-full'>
                        <div className='flex gap-2 w-[100%]'>
                            ...
                            <div className='bg-[#0D0716] border border-[#392e4e] p-4 rounded-xl flex flex-col justify-center gap-2 w-[25%]'>
                                ...
                                <div className='flex justify-between '>
                                    <div className='flex flex-col'>
                                            <p className='font-bold text-md mb-1 flex items-center gap-2'>Monday 
                                            <GradientText
                                                colors={["#8660fa", "#a855f7", "#8400ff", "#a855f7", "#8660fa"]}
                                                animationSpeed={10}
                                                showBorder={false}
                                                className="custom-class"
                                                >
                                                <h1 className="text-lg font-extrabold">25%</h1>
                                            </GradientText>
                                        </p>

                                        <p className='font-bold text-md mb-1 flex items-center gap-2'>Tuesday 
                                            <GradientText
                                                colors={["#8660fa", "#a855f7", "#8400ff", "#a855f7", "#8660fa"]}
                                                animationSpeed={10}
                                                showBorder={false}
                                                className="custom-class"
                                                >
                                                <h1 className="text-lg font-extrabold">70%</h1>
                                            </GradientText>
                                        </p>
                                    </div>
                            ...
                            <div className='bg-[#0D0716] border border-[#392e4e] p-4 rounded-xl flex justify-center items-center gap-2 w-[25%]'>
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2 my-2">
                                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">React</span>
                                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">JavaScript</span>
                                        ...
                                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">Tailwind CSS</span>
                                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">Node.js</span>
                                    </div>
                                </div>
                            ...
                            <div className='bg-[#0D0716] border border-[#392e4e] p-4 rounded-xl flex flex-col justify-center gap-2 w-[25%]'>
                                ...
                                <div className='flex justify-between '>
                                    <div className='flex flex-col'>
                                            <p className='font-bold text-md mb-1 flex items-center gap-2'>Tech 
                                            <GradientText
                                                colors={["#8660fa", "#a855f7", "#8400ff", "#a855f7", "#8660fa"]}
                                                animationSpeed={10}
                                                showBorder={false}
                                        ...
                                        <p className='font-bold text-md mb-1 flex items-center gap-2'>Software 
                                            <GradientText
                                                colors={["#8660fa", "#a855f7", "#8400ff", "#a855f7", "#8660fa"]}
                                                animationSpeed={10}
                                                showBorder={false}
                                ...
                                <div className='flex justify-between '>
                                    <div className='flex flex-col'>
                                            ...
                                            <GradientText
                                                ...
                                                className="custom-class"
                                                >
                                                <h1 className="text-lg font-extrabold">3.5</h1>
                                            </GradientText>
                                        </p>

                                        <p className='font-bold text-md mb-1 flex items-center gap-2'>Startups 
                                            <GradientText
                                                colors={["#8660fa", "#a855f7", "#8400ff", "#a855f7", "#8660fa"]}
                                                animationSpeed={10}
                                                showBorder={false}
                                                className="custom-class"
                                                >
                                                <h1 className="text-lg font-extrabold">2.8</h1>
                                            </GradientText>
                                        </p>
                                    </div>
                    ...
                    <div className='mt-6 flex gap-4 w-full' >
                        <section aria-labelledby="comparison-title" className='w-[70%]'>
                                ...
                                <table className="table-auto w-full">
                                    ...
                                    <tbody className="divide-y divide-[#392e4e]">
                                        <tr className="hover:bg-[#392e4e] transition-colors">
                                            <td className="p-4 font-medium text-white">TechCorp Solutions</td>
                                            <td className="p-4 text-gray-200">8</td>
                                            <td className="p-4 text-gray-200">50%</td>
                                            <td className="p-4 text-gray-200">$130,000</td>
                                            <td className="p-4 text-purple-600 font-medium">12.5%</td>
                                        </tr>
                                        <tr className="hover:bg-[#392e4e] transition-colors">
                                            <td className="p-4 font-medium text-white">DataSys Inc.</td>
                                            <td className="p-4 text-gray-200">12</td>
                                            <td className="p-4 text-gray-200">25%</td>
                                            <td className="p-4 text-gray-200">$125,000</td>
                                            <td className="p-4 text-purple-600 font-medium">8.3%</td>
                                        </tr>
                                        <tr className="hover:bg-[#392e4e] transition-colors">
                                            <td className="p-4 font-medium text-white">FinTech Global</td>
                                            <td className="p-4 text-gray-200">5</td>
                                            <td className="p-4 text-gray-200">20%</td>
                                            <td className="p-4 text-gray-200">$140,000</td>
                                            <td className="p-4 text-red-500 font-medium">0%</td>
                                        </tr>
                                        <tr className="hover:bg-[#392e4e] transition-colors">
                                            <td className="p-4 font-medium text-white">QuantumLeap AI</td>
                                            <td className="p-4 text-gray-200">2</td>
                                            <td className="p-4 text-gray-200">100%</td>
                                            <td className="p-4 text-gray-200">$150,000</td>
                                            <td className="p-4 text-purple-600 font-medium">50.0%</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
