  ...
  return (
    <div className="w-full h-full font-sans">
      ...
      <div className="relative h-64 w-full mt-4 group">
        ...
        <div className="absolute top-14 left-0 w-full flex flex-col items-center justify-end pointer-events-none">
          <span className="text-5xl font-black text-gray-200 leading-none">{totalApplications}</span>
          <span className="text-slate-400 text-sm font-medium mt-1 mb-6">Application Sources</span>
